  ...
  return (
    <DashboardLayout activeItem="jobs" onNavigate={onNavigate} title="Job Matching">
      ...
      <MatrixCard className="mb-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-slate-500 text-sm">Min Fit:</span>
            <input
              type="range"
              min="0"
              max="100"
            ...
            />
            <span className="text-slate-900 text-sm font-medium">{filters.minFit}%</span>
          </div>
        ...
        >
          ...
          >
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              ...
              <button onClick={() => setShowCoverLetter(false)} className="text-slate-400 hover:text-slate-900">
                <X className="w-6 h-6" />
              </button>
            </div>
            <div className="p-6">
      ...
      {showApplyPanel && selectedJob && (
        ...
        >
          <div
            className="w-full max-w-lg bg-white border-l border-slate-200 h-full overflow-auto shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <h3 className="text-xl font-bold text-slate-900">Tailored Application</h3>
              <button onClick={() => setShowApplyPanel(false)} className="text-slate-400 hover:text-slate-900">
                <X className="w-6 h-6" />
              </button>
            </div>
