          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                value={user?.email}
                disabled
                className="w-full bg-slate-100 border border-slate-200 text-slate-500 px-4 py-3 rounded-lg cursor-not-allowed"
              />
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-white border border-slate-200 text-slate-900 px-4 py-3 rounded-xl appearance-none focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"
                >
            ...
            <div>
              ...
              <textarea
                ...
                maxLength={250}
                className="w-full bg-white border border-slate-200 text-slate-900 px-4 py-3 rounded-xl resize-none focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 h-24"
              />
  ...
  return (
    <DashboardLayout activeItem="settings" onNavigate={onNavigate} title="Settings">
      ...
      {showDeleteModal && (
        ...
        >
          <div
            className="bg-white border border-red-200 rounded-2xl max-w-md w-full p-6"
